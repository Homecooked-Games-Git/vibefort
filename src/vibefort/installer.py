...
def _build_hook_block() -> str:
    ...
    lines.append('            RPROMPT="$(vibefort banner --short 2>/dev/null)"')
    lines.append('            printf "\\033]0;%s\\007" "$(vibefort banner --title 2>/dev/null)"')
    lines.append('        }')
    ...
    lines.append('        PROMPT_COMMAND=\'printf "\\033]0;%s\\007" "$(vibefort banner --title 2>/dev/null)"; $PROMPT_COMMAND\'')
    lines.append("    fi")
    lines.append("fi")
