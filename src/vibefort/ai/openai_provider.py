...
class OpenAIProvider:
    """OpenAI provider supporting API key and OAuth token."""
    ...
    def _call_api(self, prompt: str) -> str:
        """Send a request to the OpenAI API and return the text response."""
    ...
    def analyze_package(
        ...
        """Analyse suspicious package code via OpenAI."""
    ...
    def analyze_code(self, code: str, filename: str = "") -> AnalysisResult:
        """Analyse arbitrary code via OpenAI."""
